...
const About = () => {
  ...
  return (
    <div id='about' className="about relative overflow-x-hidden py-[150px] font-secondary bg-dark-bg">
      ...
      <Container>
        <Flex className="bg-black text-center xl:text-left flex-col xl:flex-row px-3 xl:px-[77px] py-[91px] rounded-[10px]">
          <div data-aos="fade-down-right" className="about-left xl:w-[50%]">
            <p className='text-body mb-2 text-white'>About Me</p>
            <h3 className='text-white xl:text-subheading text-subheading-sm font-bold xl:w-[510px] font-primary'>
              Professional <span className='text-primary'>Problem Solutions</span> For Digital Products
            </h3>
            <p className='xl:text-body text-body-sm mt-4 mb-9 xl:w-[450px] text-white'>
            ...
            {/* CountUp Cards */}
            <Flex className="xl:gap-[39px] flex-wrap gap-y-5 xl:w-[511px] justify-center xl:justify-start mt-6">
              {[
          ...
          <div data-aos="fade-down-left" className="about-right mt-5 xl:mt-0 relative xl:w-[50%]">
            <div className="img 
bg-[url(assets/aboutImage.jpg)] grayscale-50 hover:grayscale-0 bg-cover group border border-black hover:border hover:border-primary ms-auto relative bg-white max-w-[346px] min-w-[300px] h-[363px] font-semibold rounded-[10px]">
              <span className='bg-white text-black px-[15px] group-hover:border group-hover:border-primary py-[13px] rounded-[30px] absolute xl:left-[-99px] left-1/2 -translate-x-1/2 xl:-translate-x-0 xl:bottom-[142px] bottom-[-40px]'>
                MERN Stack Developer
              </span>
              <span className='bg-white text-black px-[44px] group-hover:border group-hover:border-primary py-[13px] font-semibold rounded-[30px] absolute xl:left-[-162px] left-1/2 -translate-x-1/2 xl:-translate-x-0 bottom-[-120px] xl:bottom-[46px]'>
                Meheraj Hosen
              </span>
            </div>
            <GoNorthStar className='text-primary w-[96px] h-[95px] animate-pulse hidden xl:block absolute top-0 left-0' />
          </div>
        </Flex>
      </Container>
    </div>
