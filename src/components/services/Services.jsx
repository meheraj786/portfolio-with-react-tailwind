...
const Services = () => {
  ...
  return (
    <div id='services' className="services bg-[url(assets/lines.png)] bg-no-repeat bg-cover overflow-x-hidden relative bg-dark-bg text-white pt-[103px] pb-[128px] font-secondary">
      <Container>
